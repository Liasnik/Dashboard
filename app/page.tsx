...
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col p-6">
      <div className="flex h-20 shrink-0 items-end justify-between gap-8 rounded-lg bg-blue-500 p-4 md:h-52">
        <Logo />
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          <div className="h-0 w-0 border-b-[40px] border-l-[30px] border-r-[30px] border-b-black border-l-transparent border-r-transparent" />
          <p
